...
from .exam_media import router as exam_media_router
...
api_v1_router.include_router(exam_media_router, tags=["Exam Media"])
api_v1_router.include_router(mesh_router, tags=["Mesh"])
