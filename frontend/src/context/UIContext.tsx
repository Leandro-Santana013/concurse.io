...
export type ThemeMode = 'light' | 'dark' | 'oled' | 'sepia' | 'emerald' | 'dracula' | 'nord' | 'tokyo-night' | 'catppuccin' | 'gruvbox' | 'monokai' | 'solarized';
...
export const UIProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    root.classList.remove(
      'theme-light', 'theme-dark', 'theme-paper', 'theme-oled', 'theme-sepia',
      'theme-emerald', 'theme-dracula', 'theme-nord', 'theme-tokyo-night',
      'theme-catppuccin', 'theme-gruvbox', 'theme-monokai', 'theme-solarized'
    );
