...
try:
    from services.pdf_pipeline.training_ast.ast_regex import parse_regex_to_ast, mutate_ast, crossover_ast, ast_to_compiled_regex
    from services.pdf_pipeline.formatters import detect_banca_family, get_specialized_patterns, BancaFamily
    HAS_AST_ENGINE = True
except ImportError:
