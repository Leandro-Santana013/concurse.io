...
def test():
    with sync_playwright() as p:
        ...
        page.goto('https://www.pciconcursos.com.br/provas/download/auxiliar-de-servico-coveiro-prefeitura-araxa-mg-gestao-concurso-2010', timeout=60000, wait_until="domcontentloaded")
